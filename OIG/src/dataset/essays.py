...
from src.basic_augment import basic_augment


class Essays(OIGBase):
    
    def __init__(self, output_path, hf_dataset_name="ChristophSchuhmann/essays-with-instructions"):
        super().__init__()
    ...
    def __call__(self):
        ...
        for idx in tqdm(range(len(dataset['train']))):
            ...
            instance = {'text':dialog, "metadata": {'source': 'essays'}}
